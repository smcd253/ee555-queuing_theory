...
from erlang_c_prob import erlang_c_prob

class ErlangCP:

    def __init__(self, f_path):
        self.root = Tk()
        self.root.title("P2: Erlang-C Probability Calculator")
    ...
    def update(self, method):
        if method == "calculate":
            ...
            result = erlang_c_prob(self.l, self.u, self.epsilon)
...
def main():
    ...
    erlang_c_prob_menu = ErlangCP(excel_path)
    erlang_c_prob_menu.root.mainloop()
